export default {
  title: "Muhamad Rizki - Tentang",
  description: "Hai, saya Muhamad Rizki.",
  ...
  content: {
    ...
    par_3:
      "Website ini saya gunakan untuk membagikan proyek pribadi, menulis seputar <em>development insights</em>, dan mendokumentasikan berbagai hal yang saya pelajari. Meskipun sebagian besar kontennya saat ini lebih condong ke topik <em>frontend</em>, cakupannya akan berkembang seiring saya mengeksplorasi bidang-bidang lain yang menarik bagi saya.",

    par_4: `Saya percaya bahwa kode yang baik bukan hanya kode yang berfungsi, tapi juga harus mudah dirawat, tangguh, dan jelas bagi siapa pun yang membacanya setelah kita. Setelah berkali-kali menghadapi <em>codebase</em> yang kacau, bug yang sulit dilacak, dan proyek tanpa dokumentasi yang memadai, saya semakin menghargai nilai dari kesederhanaan, struktur, dan kejelasan. Prinsip seperti <em>"Keep It Simple, Stupid"</em> (KISS) dan <em>clean architecture</em> bukan hanya sekadar idealisme bagi saya, tapi merupakan alat praktis untuk membangun <em>software</em> yang lebih baik.`,
